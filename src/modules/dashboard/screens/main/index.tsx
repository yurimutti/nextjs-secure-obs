    ...
    <main>
      <header className="mb-8">
        <h1 className="text-2xl font-bold text-foreground sm:text-3xl">
          Welcome to your member area{userProfile?.name ? `, ${userProfile.name}` : ''}
        </h1>
        ...
        <Card className="mb-8 border-green-200 bg-green-50/50">
          <CardContent>
            <div className="flex items-center gap-4">
              <div className="flex items-center justify-center w-12 h-12 bg-green-100 rounded-full" aria-hidden="true">
                <CheckCircle className="w-6 h-6 text-green-600" />
              </div>
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  <h2 id="membership-status" className="text-lg font-semibold text-green-900">Active Member</h2>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3 mb-8">
        <section className="lg:col-span-2" aria-labelledby="activity-section">
          <div className="mb-4">
            <h3 id="activity-section" className="text-xl font-semibold text-foreground">Your recent activity</h3>
            <p className="text-sm text-muted-foreground mt-1">Track your latest actions and events</p>
          </div>
        ...
        <Card className="bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
          <CardContent className="pt-6">
            <div className="text-center">
              <h3 id="cta-section" className="text-lg font-semibold text-blue-900 mb-2">
                Ready to explore more?
              </h3>
              <p className="text-sm text-blue-700 mb-4">
                Discover additional features and tools available in your member area
              </p>
